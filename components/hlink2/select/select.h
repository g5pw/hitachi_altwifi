...
#ifndef CONF_SELECT_RAW
  #define CONF_SELECT_RAW CONF_MESSAGE_CMD_RAW
#endif


class Select: public select::Select, public CommandComponent {
  public:
    static constexpr const char TAG[] = "hlink2:select";
    static constexpr const bool RAW = CONF_SELECT_RAW;
